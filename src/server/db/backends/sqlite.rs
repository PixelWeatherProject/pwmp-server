...
pub struct SqlitePool(r2d2_sqlite::SqliteConnectionManager);
pub struct Sqlite(r2d2_sqlite::rusqlite::Connection);

impl PoolTrait for SqlitePool {
...
impl Backend for Sqlite {
    ...
    fn send_os_update_stat(
        ...
        new_ver: pwmp_client::pwmp_msg::version::Version,
